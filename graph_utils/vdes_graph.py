...
class VDESGraph(Graph):
    def __init__(self, boat_count=10, satellite_count=2, radio_tower_count=2, **attr):
        ...
        satilite_range = [boat_count, boat_count + satellite_count]
        self.radio_tower_count = radio_tower_count
        radio_tower_range = [satilite_range[1], satilite_range[1] + radio_tower_count]
        ...
        G = nx.relabel_nodes(G, make_mapping(G, "satilite", satilite_range))
